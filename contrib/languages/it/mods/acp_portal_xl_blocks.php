...
$lang = array_merge($lang, array(
	...
	'TITLE_BLOCKS_EXPLAIN'				=> 'Puoi creare/modificare/spostare/cancellare blocchi e oggetti dal portale. Tutte le direzioni sono permesse per lo spostamento. Ci sono cinque posizioni disponibili per collocare il tuo blocco, sopra, sinistra, centro, destra e sotto. Le posizioni dei diversi blocchi sono gestibili nello stesso modo, come vedrai sulla tua pagina del portale. Entrambe le parti del blocco di gestione utilizzando gli stessi blocchi sono separati gli uni dagli altri, in modo che siano in grado di avere un diverso aspetto e sul portale indice/forum.',
	...
	'TITLE_BLOCKS_INDEX_EXPLAIN'		=> 'Puoi creare/modificare/spostare/cancellare blocchi e oggetti sulla pagina del forum. Tutte le direzioni sono permesse per lo spostamento. Ci sono cinque posizioni disponibili per collocare il tuo blocco, sopra, sinistra, centro, destra e sotto. Le posizioni dei differenti blocchi sono gestibili nello stesso modo, come vedrai nella tua pagina index/viewforum/viewtopic. Entrambe le parti del blocco di gestione utilizzano gli stessi blocchi e sono separati gli uni dagli altri, in modo che siano in grado di avere un diverso aspetto sul portale e in index/viewforum/viewtopic. <br /><br /><strong style="text-transform: uppercase;">Nota:</strong> Tieni presente di <strong>non</strong> eliminare il blocco <strong>center_forumblock.html</strong> dalla gestione blocchi, altrimenti i forum non saranno visibili!',
	...
	'TITLE_PAGES_EXPLAIN'				=> 'Puoi creare/modificare/spostare/cancellare pagine e oggetti dalla pagina portale. Tutte le direzioni sono permesse per lo spostamento. Ci sono cinque posizioni disponibili per collocare i blocchi nella tue pagine, sopra, sinistra, centro, destra e sotto. Le posizioni delle diverse pagine sono gestibili nello stesso modo, come vedrai sulla tua pagina del portale.',
	...
	'BLOCK_NAME_EXPLAIN'				=> 'Questo verrà visualizzato nel titolo del tuo blocco.',
	'BLOCK_ORD'							=> 'Ordine',
	'BLOCK_ORDER'						=> 'Ordine',
	'BLOCK_POS'							=> 'Posizione',
	...
	'ICON_DELETE'						=> 'L’eliminazione del blocco è consentita, i blocchi predefiniti non possono essere eliminati.',
	'ICON_EDIT'							=> 'La modifica del blocco è consentita, i blocchi predefiniti non possono essere modificati.',
	...
	'REG'								=> 'Registrati',
	'STAFF'								=> 'Team',
	'URL_IMG_EXPLAIN'					=> 'Url immagine visualizzata nel menu links',
	...
	'MOVE_TOP'							=> 'Sposta su di uno step superiore nalla colonna',
	...
	'PORTAL_LEFT_COLLUMN_ACTIVE'                 => 'Colonna di sinistra è attiva',
	'PORTAL_LEFT_COLLUMN_ACTIVE_EXPLAIN'         => 'Abilita/Disabilita colonna sinistra Si/No?',
	'PORTAL_LEFT_COLLUMN_WIDTH_EXPLAIN'          => 'Modifica la larghezza della colonna di sinistra, valore raccomandato 180px',
	
	'PORTAL_RIGHT_COLLUMN_WIDTH'                 => 'Larghezza colonna destra',
	'PORTAL_RIGHT_COLLUMN_ACTIVE'                => 'Colonna di destra è attiva',
	'PORTAL_RIGHT_COLLUMN_ACTIVE_EXPLAIN'        => 'Abilita/Disabilita colonna destra Si/No?',
	'PORTAL_RIGHT_COLLUMN_WIDTH_EXPLAIN'         => 'Modifica la larghezza della colonna di destra, valore raccomandato 180px',
	
	'PORTAL_LAYOUT'                 			=> 'Layout portale',
	'PORTAL_LAYOUT_ACTIVE'                		=> 'Visualizza layout nel portale',
	'PORTAL_LAYOUT_EXPLAIN'        				=> 'Questo pulsante è in grado di accendere o spegnere la/e colonna/e sinistra e destra con un solo clic senza l’uso delle opzioni di seguito indicate, la colonna centrale si ridimensiona automaticamente. <br /> Abilita/Disabilita Si/No?',
	...
	'PORTAL_INDEX_LAYOUT_EXPLAIN'        		=> 'Questo pulsante è in grado di accendere o spegnere la/e colonna/e sinistra e destra con un solo clic senza l’uso delle opzioni di seguito indicate, la colonna centrale si ridimensiona. <br /> Abilita/Disabilita Si/No?',
	
	'PORTAL_PAGES_LAYOUT'                 		=> 'Layout pagine',
	'PORTAL_PAGES_LAYOUT_ACTIVE'                => 'Mostra colonna layout nelle pagine del portale',
	'PORTAL_PAGES_LAYOUT_EXPLAIN'        		=> 'Questo pulsante è in grado di accendere o spegnere la/e colonna/e sinistra e destra con un solo clic senza l’uso delle opzioni di seguito indicate, la colonna centrale si ridimensiona. <br /> Abilita/Disabilita Si/No?',
	...
	'PORTAL_PAGES_PAGE_ACTIVE_NUMBER_EXPLAIN'  => 'L’Id della pagina (è necessario indicare l’ID della pagina), separato da virgole per multi-pagine, es. 1,2,5. Non lasciare questo campo vuoto, in mancanza di un valore personale è richiesto lo 0. Successivamente le pagine saranno impaginate.',
