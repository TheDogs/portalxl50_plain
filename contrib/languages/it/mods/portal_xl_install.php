...
$lang = array_merge($lang, array(
	...
	'PORTAL_INSTALL_FINISHED_EXPLAIN'	=> '
		...
		<p>Cliccando sul pulsante sotto andrai sul tuo pannello di amministrazione (ACP). Prendi un po di tempo per esaminare le opzioni a tua disposizione. Ricorda che è disponibile un aiuto on-line per la lingua inglese su <a href="http://www.portalxl.nl/forum/">Portal XL Home</a> e sul <a href="http://www.portalxl.nl/forum/viewforum.php?f=1">forum di supporto</a> per Portal XL 4.0 Premod RC5, o sul <a href="http://www.portalxl.nl/forum/viewforum.php?f=44">forum di supporto</a> per Portal XL 5.0 Plain.</p><p>Il supporto in italiano invece è disponibile su <a href="http://www.portalxl.eu">Portal XL Italia</a>.</p><p><strong>Cancella, sposta o rinomina la directory di installazione. Se la directory è presente, solo l’amministrazione sarà accessibile.</strong></p>',
	...
	'PORTAL_REMOVE_SUCCESS'			=> 'Congratulazioni!<br />Hai eliminato dal database Portale XL con successo.<br /><br />Puoi ora eliminare i file di portal XL dal tuo server.<br /><br />Non dimenticare di cancellare la cartella /install/.',
