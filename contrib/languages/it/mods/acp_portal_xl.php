...
$lang = array_merge($lang, array(
   ...
   'ACP_PORTAL_INFO_EXPLAIN'           			=> 'Grazie per aver scelto Portal XL 5.0 come portale per il tuo forum. Su questo pagine puoi gestire il portale del tuo forum. Le schermate che stai vedendo daranno una rapida panoramica di tutte le varie impostazioni del portale. I links sulla sinistra di questa schermata ti permettono di controllare ogni aspetto della gestione del portale. La configurazione ACP è di Mysterious 2007. La traduzione italiana è di Portal xl e Portal xl Premod è a cura di Lucky (www.portalxl.eu).<br />
   ...
   'ACP_PORTAL_ANNOUNCE_SETTINGS_EXPLAIN'       => 'Qui puoi modificare gli annunci ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_NEWS_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare le news ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_RECENT_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare i messaggi recenti ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_PAYPAL_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare le tue informazioni paypal ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_MEMBERS_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare le tue informazioni utenti ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_BOTS_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare le tue informazioni bots ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_POLLS_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare le tue informazioni sondaggi ed alcune loro opzioni specifiche.',
   'PORTAL_POLL_TOPIC'                         	=> 'Sondaggi visualizzati',
   'PORTAL_POLL_TOPIC_EXPLAIN'                  => 'Visualizza blocco Si/No?',
   'PORTAL_POLL_TOPIC_ID'                      	=> 'Visualizza sondaggi del relativo argomento con ID',
   ...
   'ACP_PORTAL_MOST_POSTER_SETTINGS_EXPLAIN'    => 'Qui puoi modificare le tue informazioni autori ed alcune loro opzioni specifiche.',
   ...
   'ACP_PORTAL_SWITCHES_SETTINGS_EXPLAIN'       => 'Qui puoi modificare le tue informazioni blocchi ed alcune loro opzioni specifiche.',
   'PORTAL_GOOGLE_S_BLOCK'                  	=> 'Aggiungi Google',
   'PORTAL_GOOGLE_S_BLOCK_EXPLAIN'              => 'Vuoi visualizzare questo blocco Si/No? <br /> Google; ha un blocco partern predefinito 120x240_as, il nome del file è <strong>google_adds.html</strong>.',
   'PORTAL_GOOGLE_C_BLOCK'                  	=> 'Aggiungi Google centrale',
   'PORTAL_GOOGLE_C_BLOCK_EXPLAIN'              => 'Vuoi visualizzare questo blocco Si/No? <br /> Google, ha un blocco partern predefinito 234x60_as, il nome del file è <strong>google_adds_portal.html</strong>.',
   ...
   'PORTAL_RANKS_EXPLAIN'                  		=> 'Vuoi visualizzare questo blocco Si/No? <br /> Questa scheda include wordgraph, livelli, allegati ed elenco del forum. Scegli "No" per disabilitare il blocco.',
   ...
   'ACP_PORTAL_WORDGRAPH_SETTINGS'              => 'Configurazione Wordgraph',
   'ACP_PORTAL_WORDGRAPH_SETTINGS_EXPLAIN'      => 'Qui puoi modificare le tue informazioni sul Wordgraph ed alcune opzioni specifiche.',
   'PORTAL_WORDGRAPH'                  			=> 'Mostra Wordgraph',
   ...
   'PORTAL_WORD_GRAPH_WORD_COUNTS'              => 'Parole da visualizzare',
...
*/
   ...
   'ACP_PORTAL_WELCOME_SETTINGS_EXPLAIN'       	=> 'Qui puoi modificare il messaggio di benvenuto ed alcune sue opzioni specifiche.',
   ...
   'ACP_PORTAL_SHOUTBOX_SETTINGS_HCB'			=> 'Configurazione altezza e colore blocco',
   ...
   'PORTAL_WEATHER_ALTERNATE_URL'              	=> 'L’url del tuo sito meteo alternativo ',
   'PORTAL_WEATHER_ALTERNATE_URL_EXPLAIN'       => 'Incolla il tuo url qui. Lascia vuoto per non visualizzarlo',
   'PORTAL_WEATHER_ALTERNATE_URL1'              => 'L’url del tuo sito meteo alternativo',
   'PORTAL_WEATHER_ALTERNATE_URL1_EXPLAIN'      => 'Incolla il tuo url qui. Lascia vuoto per non visualizzarlo',
   'PORTAL_WEATHER_ALTERNATE_URL2'              => 'L’url del tuo sito meteo alternativo',
   'PORTAL_WEATHER_ALTERNATE_URL2_EXPLAIN'      => 'Incolla il tuo url qui. Lascia vuoto per non visualizzarlo',
   ...
   // corrected/added since RC5 below
	...
	'COUNTER_DISPLAY_STATS'				=> 'Visualizza statistiche contatore',
	...
	'COUNTER_BLOCK_IP_EXPLAIN'			=> 'Abilita monitoraggio/blocco degli indirizzi IP per il contatore. Questa opzione potrà funzionare correttamente se gli utenti aggiorneranno il loro browser entro il limite di tempo fissato nei campi di sotto.',
	...
	'SELECT_COUNTER_DISPLAY_MODE'			=> 'Metodo di visualizzazione contatore',
	'SELECT_COUNTER_DISPLAY_MODE_EXPLAIN'	=> 'Seleziona il metodo di visualizzazione per il contatore. <br /><strong>Nota</strong>: Puoi <strong>sempre</strong> cliccare/attivare <strong>mostra immaggini</strong> o <strong>Visualizza come testo</strong>, prima di salvare le modifiche.',
